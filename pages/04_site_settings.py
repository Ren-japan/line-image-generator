...
# 参照画像のカテゴリ定義（LINE版）
# 表紙・設問・結果(1枚)はデザインが大きく異なることがあるため別カテゴリに分離
# （2026-07-28 Noa指摘）。ジャンル1つ=1セットのまま（パターン管理は不要との判断）。
REF_CATEGORIES = [
    ...
    {"key": "cover", "icon": "📔", "label": "診断表紙", "help": "診断カルーセルの表紙（タイトル画面）の参照デザイン。"},
    {"key": "questions", "icon": "❓", "label": "診断設問", "help": "診断カルーセルの設問パネルの参照デザイン。"},
    {"key": "result", "icon": "🏁", "label": "診断結果（1枚）", "help": "診断カルーセル内の結果スライド（1枚）の参照デザイン。タイプ別の複数枚組は「結果カルーセル」タブへ。"},
